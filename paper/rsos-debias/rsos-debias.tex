...
\begin{figure}
\centering
\includegraphics[width=5.20833in,height=6.45833in]{figures/01_table-variable-dictionary_explain.png}
...
\phantomsection\label{fig-radialplots_ref}
\includegraphics[width=\textwidth,height=0.6\textheight]{figures//radial-plots_feature-importance.pdf}

\textbf{Top ten raions with the largest cumulative net negative (in blue) and positive (in red) migration balance organised from the largest to the smallest, February to August 2022.}
