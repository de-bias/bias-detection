...
\title{A systematic machine learning approach to quantifying the extent of bias in human population data from mobile phones}
...
\begin{figure}
\centering
\includegraphics[width=4.79167in,height=4.89583in]{figures/01_table-variable-dictionary.pdf}
...
While the findings in Figure \citet{fig:survey} demonstrate the potential of
...
Figure \citet{fig:size-bias-spatial} shows the geographic variation of the size
