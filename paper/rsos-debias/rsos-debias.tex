...
\phantomsection\label{fig:radial-plots}
\begin{figure}
\centering
\includegraphics[width=\textwidth,height=0.5\textheight]{figures/radial-plots_feature-importance.pdf}
\caption{Feature importance of predictors contributing to data production bias,
XGboost estimates}\label{fig:radial-plots-composite}
\end{figure}
