...
gtsave(tbl_vars, "/Users/carmen/Documents/github/de-bias/bias-detection/paper/rsos-debias/figures/01_table-variable-dictionary.pdf",   vwidth  = 1400,   # wider canvas
...
gtsave(
  tbl_vars,
  "/Users/carmen/Documents/github/de-bias/bias-detection/paper/rsos-debias/figures/01_table-variable-dictionary_explain.pdf",
  vwidth  = 900,   # ~A4 portrait-friendly viewport
  vheight = 1250,
  zoom    = 1
)

# --- save second table to editable Word document ----------------------------
docx_path <- "/Users/carmen/Documents/github/de-bias/bias-detection/paper/rsos-debias/figures/01_table-variable-dictionary_explain-editable.docx"

ft <- tbl %>%
  flextable() %>%
  set_header_labels(Bias_explanation = "Bias explanation") %>%
  theme_booktabs() %>%
  ...
  width(j = "Dimension", width = 1.0) %>%
  width(j = "Variable", width = 1.2) %>%
  width(j = "Bias_explanation", width = 4.0) %>%
