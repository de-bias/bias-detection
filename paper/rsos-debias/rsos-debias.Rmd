...
to the Local Authority District (LAD) level.](figures/01_table-variable-dictionary_explain.png){width="500" height="620"}
...
::: {#fig-radialplots_ref layout="[[1], [1]]"}
![](figures//radial-plots_feature-importance.pdf){#fig-radialplots height="60%"}

**Top ten raions with the largest cumulative net negative (in blue) and positive (in red) migration balance organised from the largest to the smallest, February to August 2022.**
:::
