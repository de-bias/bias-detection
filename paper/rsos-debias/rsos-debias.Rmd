...
![Supplementary Table 1. Summary description of data sources used in the
article, including key
features.](figures/table-data-source.png){width="500" height="170"}
...
February 2019 to December 2021. For this study, we restrict analysis to March 2021 to align with the 2021 UK Census. User locations are assigned to Local Authority Districts (LADs) based on a frequency-based home detection algorithm, further detailed in [@wang2022]
[@wang2022] .
