...
population counts. This dataset is openly-available on Zenodo^[https://zenodo.org/records/13327082], and was processed to
...
### Identifying spatial patterns of population coverage bias
...
band, and 4) user-defined distance band [@rey2023].
...
![Size of population coverage bias (bottom x-axis) and population coverage per
...
their respective distributions, as displayed in the cartograms and histograms. This result is consistent with recent findings for urban areas in the US [@nijs2025].
