...
[@rowe23-bigdata]. Mobile phone application data (MPAD) offer high spatially granular, frequent and instant information to
...
and use of the mobile phone applications used to collect data [@wesolowski13-biases]. Only a fraction of
...
The use of MPAD can thus have major practical and
