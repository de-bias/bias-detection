...
LAD.](figures/table-census-data.png){width="450" height="460"}
...
::: {#fig:radial-plots layout="[[1], [1]]"}
![Feature importance of predictors contributing to data production bias,
XGboost estimates](figures/radial-plots_feature-importance.pdf){#fig:radial-plots-composite height="50%"}
:::
