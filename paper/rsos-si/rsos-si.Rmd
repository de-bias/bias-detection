...
tts-week, stt-month, stt-week --> test for linear correlation between these and tts-month

# Testing for spatial autocorrelation in the size of bias

according to multiple spatial weighting schemes --> compute moran's I and p-values, display them in a table (schemes as columns, data source as rows) 
