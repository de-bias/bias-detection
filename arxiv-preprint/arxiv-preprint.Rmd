...
authors:
  - name: "Carmen Cabrera\\textsuperscript{*}"
    department: Geographic Data Science Lab, Department of Geography and Planning
  ...
  - name: Francisco Rowe
    ...
    thanks: The authors contributed equally to all the stages of the work.
abstract: |
...
through their Data for Good Initiative^[https://dataforgood.facebook.com]. This dataset provides
...
source.](figures/compare-surveys-two-axis.png){#fig:survey width="14.5cm"
height="8.5cm"}
...
bias.](figures/Fig-size-bias.png){#fig:bias-size width="14.5cm"
height="13.5cm"}
...
district.](figures/explain-bias.png){#fig:shap-plots width="14.5cm"
height="12.5cm"}
