...
If darker colours indicate that high values of a variable are associated with negative or positive values on the outcome / target variable.
...
sv_dependence(shp, v = names(shp$X)[1:9] )
```

::: callout-note
### **How to interpret the plot above**

The plot shows how a variable is associated with changes in shap values.
:::
