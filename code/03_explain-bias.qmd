...
if (dfd == "twitter") {
  ...
  df_bias <- read.csv(paste0(wd, "/data/outputs/fb/census-month/populations/stt/active-population-bias/active_population_bias_lad_w_db.csv")) %>% rename("geography.code" = "code")
  }
