...
if (dfd == "twitter") {
  df_bias <- read.csv(paste0(wd, "/data/outputs/twitter/monthly/populations/active-population-bias/active_population_bias_lad_w_fbw.csv")) %>% rename("geography.code" = "code") 
...
if (dfd == "twitter"){
  ...
  write_csv(hyper_grid, paste0(wd, "/data/outputs/mapp1/populations/tts/explain-bias/hypergrid_lad.csv"))
  } else if (dfd == "mapp1") {
  write_csv(hyper_grid, paste0(wd, "/data/outputs/mapp2/populations/stt/explain-bias/hypergrid_lad.csv"))
  }
...
if (dfd == "twitter"){
  ...
  hyper_grid <- read_csv(paste0(wd, "/data/outputs/mapp1/populations/stt/explain-bias/hypergrid_lad.csv"))  
  } else if (dfd == "mapp2") {
  hyper_grid <- read_csv(paste0(wd, "/data/outputs/mapp2/populations/stt/explain-bias/hypergrid_lad.csv"))  
  }
...
if (dfd == "twitter"){
  ...
  saveRDS(xgb.fit.final, paste0(wd, "/data/outputs/mapp1/populations/tts/explain-bias/xgb-fit-final-lad.rds"))
  } else if (dfd == "mapp2") {
  saveRDS(xgb.fit.final, paste0(wd, "/data/outputs/mapp2/populations/stt/explain-bias/xgb-fit-final-lad.rds"))
  }
```
