...
if (dfd == "twitter") {
  ...
  df_pop_dfd <- st_read(paste0(wd, "/data/outputs/mapp1/locations-home/lad/home-location-count_lda.gpkg")) %>% 
  rename("pop_dfd" = "home_location_count") %>% st_drop_geometry() %>% as.data.frame()
  } else if (dfd == "mapp2") {
  df_pop_dfd <- read.csv(paste0(wd, "/data/outputs/mapp2/locations-home/lad/home-location-count_lad_htw.csv")) %>% 
  rename("code" = "LAD22CD")
  }
```
