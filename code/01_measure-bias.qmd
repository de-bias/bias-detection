...
```{r}
# Compute spatial lag
bias_w <- lag.listw(w_queen, st_bias_map$bias, NAOK=TRUE)
```
...
# Recompute spatial lag with no NAs
bias_w <- lag.listw(w_queen, st_bias_map$bias, NAOK=TRUE)
...
```{r}
if (dfd == "twitter"){
  write.csv(st_drop_geometry(st_bias_map), paste0(wd, "/data/outputs/twitter/monthly/populations/active-population-bias/active_population_bias_lad_w.csv"))
  } else if (dfd == "fb_tts_census_week") {
  write.csv(st_drop_geometry(st_bias_map), paste0(wd, "/data/outputs/fb/census-week/populations/tts/active-population-bias/active_population_bias_lad_w.csv"))
  } else if (dfd == "fb_tts_census_month") {
  write.csv(st_drop_geometry(st_bias_map), paste0(wd, "/data/outputs/fb/census-month/populations/tts/active-population-bias/active_population_bias_lad_w.csv"))
  } else if (dfd == "fb_stt_census_week") {
  write.csv(st_drop_geometry(st_bias_map), paste0(wd, "/data/outputs/fb/census-week/populations/stt/active-population-bias/active_population_bias_lad_w.csv"))
  } else if (dfd == "fb_stt_census_month") {
  write.csv(st_drop_geometry(st_bias_map), paste0(wd, "/data/outputs/fb/census-month/populations/stt/active-population-bias/active_population_bias_lad_w.csv"))
  }
```
...
result <- moran.mc(st_bias_map$bias, w_queen, nsim=1000, alternative="two.sided")
