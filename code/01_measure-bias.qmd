...
```{r}
# Set digital trace data source: twitter, fb_tts_census_week, fb_tts_census_month, fb_stt_census_week, fb_stt_census_month, multiapp
dfd <- "multiapp"
...
if (dfd == "twitter") {
  ...
  rename("name" = "LAD21NM")
  } else if (dfd == "multiapp") {
  df_pop_dfd <- st_read(paste0(wd, "/data/outputs/pw/home-locations/hex/home-location-count_lda.shp")) %>% 
...
if (dfd == "twitter"){
  ...
  write.csv(df_bias, paste0(wd, "/data/outputs/pw/census-month/populations/active-population-bias/active_population_bias_lad.csv"))
  }
...
if (dfd == "twitter") {
  ...
  ggsave(paste0(wd_local, "/bias-detection/outputs/preliminary/multiapp/size-bias/scatter/multiapp_lad_census_month.png"), bg="white")
  }
```
...
if (dfd == "twitter") {
  ...
  ggsave(paste0(wd_local, "/bias-detection/outputs/preliminary/multiapp/size-bias/histogram/multiapp_lad_census_month.png"), bg="white")
  }
```
...
## Imputing NA values with their spatial lag according to queen neighbours
...
if (dfd == "twitter"){
  ...
  write.csv(st_drop_geometry(st_bias_map), 
            paste0(wd, "/data/outputs/pw/census-month/populations/active-population-bias/active_population_bias_lad", suffix, ".csv"))
}
```
...
if (dfd == "twitter") {
  ...
  ggsave(paste0(wd_local, "/bias-detection/outputs/preliminary/multiapp/size-bias/map/multiapp_lad_census_month_hex", suffix, ".png"), bg="white") 
  }
```
