...
# Use Roboto for ALL radar plots (register Google font and enable showtext)
library(sysfonts)
library(showtext)
sysfonts::font_add_google("Roboto Condensed", "robotocondensed")
showtext::showtext_auto()

# Make Roboto the default ggplot font (helps ggradar too)
theme_set(theme_minimal(base_family = "robotocondensed"))
```
