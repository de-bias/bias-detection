...
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts001/census2021-ts001-msoa.csv")) %>%
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts003/census2021-ts003-msoa.csv"))
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts004/census2021-ts004-msoa.csv"))
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts006/census2021-ts006-msoa.csv"))
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts007a/census2021-ts007a-msoa.csv")) 
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts008/census2021-ts008-msoa.csv")) 
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts011/census2021-ts011-msoa.csv")) 
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts016/census2021-ts016-msoa.csv")) 
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts017/census2021-ts017-msoa.csv")) 
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts021/census2021-ts021-msoa.csv")) 
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts037/census2021-ts037-msoa.csv")) 
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts038/census2021-ts038-msoa.csv")) 
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts045/census2021-ts045-msoa.csv")) 
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts046/census2021-ts046-msoa.csv")) 
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts054/census2021-ts054-msoa.csv")) 
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts061/census2021-ts061-msoa.csv")) 
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts062/census2021-ts062-msoa.csv")) 
...
```{r}
df_read <- read.csv(paste0(wd, "/data/inputs/census/census2021-ts/census2021-ts067/census2021-ts067-msoa.csv")) 
...
oa_x <- read.csv(paste0(wd, "/data/inputs/ons_rural-urban-classification/Output_Area_to_Lower_layer_Super_Output_Area_to_Middle_layer_Super_Output_Area_to_Local_Authority_District_(December_2021)_Lookup_in_England_and_Wales_v3.csv")) %>%
  select(OA21CD, MSOA21CD, MSOA21NM)
...
rural_pct <- rural_pct %>% select(MSOA21CD, rural_pop, rural_pct)

df <- df %>% left_join(rural_pct,
                join_by("geography.code" == "MSOA21CD"))
```

# Save data

```{r}
write.csv(df, paste0(wd, "/data/inputs/census/census2021-ts/combined-data-msoa.csv"))
```
